...
INSERT INTO `blog` VALUES (1,'first','hello world','摘要',0,1,'2020-03-18 04:29:42',1),(2,'哈哈','你好呀','摘要',0,1,'2020-03-18 04:33:37',1),(3,'房东是','范德萨发','摘要',0,1,'2020-03-18 04:34:37',1),(4,'房东是','范德萨发','摘要',0,0,'2020-03-18 04:35:11',1),(5,'房东是','发士大夫但是','摘要',0,5,'2020-03-18 04:37:36',1),(6,'广泛大使馆','后果脚后跟','摘要',0,18,'2020-03-18 04:38:48',1),(7,'广泛大使馆','后果脚后跟','摘要',0,0,'2020-03-18 04:39:12',1),(8,'广泛大使馆广泛大概','后果脚后跟给对方鼠标 ','摘要',0,0,'2020-03-18 04:39:19',1),(9,'广泛大使馆的','过的法国','摘要',0,0,'2020-03-18 06:23:44',1),(10,'广东省','广泛的','摘要',0,0,'2020-03-18 06:25:57',1),(11,'广泛的','广东佛山','摘要',0,0,'2020-03-18 06:28:12',1),(12,'广东佛山','广泛的','摘要',0,0,'2020-03-18 06:28:37',1),(13,'广泛的','广东佛山','摘要',0,0,'2020-03-18 06:29:47',1),(14,'房东是','发士大夫','摘要',0,0,'2020-03-18 06:46:25',1),(15,'发生的','富士达','摘要',0,0,'2020-03-18 06:47:03',1),(16,'大家好','欢迎来到王者荣耀','摘要',0,0,'2020-03-18 08:21:38',1),(17,'你好','abcdefg','摘要',0,0,'2020-03-18 08:22:30',1),(18,'的萨芬还是抠脚大汉','飞洒发的房东是发生','摘要',0,4,'2020-03-18 08:24:49',1),(19,'retetertretr','fdsfdsfgd','摘要',0,1,'2020-03-18 08:27:53',1),(20,'1111111111','111111111111111111','111111111111111111',0,3,'2020-03-18 08:34:03',1),(21,'22222222222','222222222222222222','222222222222222222',0,2,'2020-03-18 08:40:28',1),(22,'啦啦啦','0：成功 1：失败\n\n1：成功 0：失败\n\n不知道你们是怎么想的，我最初想的是boolean值，1为真，0为假，所以想当然的认为1表示成功，0表示失败\n\n在项目开发过过程中，我们可能会碰到用户登录的问题，正常、注销、拉黑，锁定等情况\n\n0：正常 1：注销 2：拉黑 3：锁定\n\n0：注销 1：正常 2：拉黑 3：锁定\n\n这样一看，还是0表示成功香，后来的我才知道，大部分人都是用0表示成功的，大于0都是非成功，多好','0：成功 1：失败\n\n1：成功 0：失败\n\n不知道你们是怎么想的，我最初想的是boolean值，1为',0,1,'2020-03-18 08:41:36',1),(23,'hello ','你好','你好',0,0,'2020-03-20 01:54:31',15),(24,'粗体测试','**这里是粗体**','**这里是粗体**',0,0,'2020-03-23 08:39:28',1),(25,'111','lalala','lalala',0,0,'2020-03-24 13:16:37',16),(26,'广泛的','广泛的','广泛的',0,0,'2020-03-26 06:37:50',16),(27,'大家好','真的好','真的好',0,0,'2020-03-26 07:23:00',16),(28,'00000000000','000000000000000','000000000000000',0,0,'2020-03-26 07:23:56',16),(29,'范德萨发','房东是','房东是',0,3,'2020-03-26 07:24:34',16),(30,'房东是','范德萨','范德萨',0,0,'2020-03-26 07:29:02',16),(31,'范德萨','发生的\n![image](E:/迅雷下载/测试头像.jpg)','发生的\n![image](E:/迅雷下载/测试头像.jpg)',0,0,'2020-03-27 04:15:21',4),(32,'hgfh','![image](E:/迅雷下载/测试头像.jpg)','![image](E:/迅雷下载/测试头像.jpg)',0,0,'2020-03-27 04:22:17',4);
...
-- Dump completed on 2020-04-01  8:36:55
